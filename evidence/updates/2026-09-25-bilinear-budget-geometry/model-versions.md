...
## Bilinear 8000-update sibling: single-seed screen passed

`bilinear-budget8000-v1` uses the original seed-1729 parent, exact-zero residual
and fresh AdamW for 8000 updates. Parent pretraining remains 2000 steps. The
architecture and balanced-BCE objective are unchanged; the new evaluator is
`plm-bilinear-budget8000-screen-v1`. Recipe SHA
`f976442315433e32d5c88ce2f4e911509ec5ea56542fc2a247893cefd0ddfefc`.

Final checkpoint `6979013750eb8f2780917f714192850aae411a48490757236a891fea7e351f91`
retains all 93 original tensors and adds the trained residual and optimizer
state. Its 216/222 exact answers, macro F1 0.9998843626799785 and group counts
103/51/62 pass every declared comparator floor. Against the accepted 2000-update
sibling it gains nine exact answers and loses none. This is a passed validation
screen, with no serving promotion or protected evaluation.
...
and owner decision `2cadf9dce7ee36cc4095a10a746cc1608d5ce4437724872c1eec1c88e915c195`
identify distinct evidence and acceptance records. Runner SHA
`cd593c14c429247837c26b09754509d5cfd1dd36adb317f56522a80a78a25122`
is distinct from the inherited scorer identity. Matching historical loss-prefix
values are descriptive and do not establish intermediate tensor equality.

The [additive inventory](experiments/2026-09-25-bilinear-budget8000-model-version-inventory.json),
SHA `58b8de7ab229c29b59adb426e41b623df5f55fb6fdbc647a44ccd67e551c1ee1`,
freshly verifies bytes for all **35 final checkpoints**. Older payloads/configs
were not revalidated, and periodic checkpoints are outside that inventory.
Local hashes do not establish durable backup. See the
[portable result](experiments/2026-09-25-bilinear-budget8000.json) and
[Lesson 47](learning/47-more-updates-with-the-same-objective.md).

## Bilinear 8000-update replication: both fresh seeds passed

`bilinear-budget8000-replication-v1` repeats the fixed 8000-update residual
recipe from each original parent, exact-zero A and fresh AdamW. Architecture
`plm-frozen-symmetric-bilinear-residual-v1` and objective
`plm-bilinear-residual-balanced-bce-v1` stay fixed. Evaluator identity is
`plm-bilinear-budget8000-replication-v1`; recipe SHA
`20fad007be0d1852e86086229edc7c9c760117039f0685288d4e8e22f695075f`.
Parent pretraining remains 2000 steps, recorded separately from 8000 residual updates.

| Parent seed | New final checkpoint SHA256 | Exact / matching2000 | Gains / losses |
| --- | --- | --- | --- |
| 1730 | `b3e47911015a992c3c805a5643816ee262987f5c7707fa7596f284ec03aa7c27` | 220/222 / 212/222 | 8 / 0 |
| 1731 | `d22a510e7a0571a0f86164f8d1dacda46f95594b9bcf8154699d04beb51bd567` | 214/222 / 208/222 | 6 / 0 |

Each derivative preserves all 93 original tensors and adds A plus optimizer
state. Both pass their own exact-count, F1 and group floors. Fresh totals are
434/444 exact and macro F1 0.9999150875083046; with historical development seed
1729, 650/666 and 0.9999048458988625. These observations reuse 222 validation queries.
All remaining errors are dual-TYPE. No serving promotion or protected evaluation.

Primary runner SHA `5da5ad02365f72f5e8a7123183d0b5d2f56e50c3538e64e2ac984e2b491230dd`,
aggregate-v2 SHA `77cc2ee2ebf4dc1f8671e71833712302160190c85477eb6e0dd0b5494bb3cde6`,
independent aggregate audit SHA
`49fc5d7edc7763870ac0e9310295385d8e6a3af6e67d3cc6b5a9f0e44bc2ae77`,
and owner decision SHA
`01a9faefb90ee3d3e7525c0d5191d41741131843dc79ea2b44d860c5c8e21d5e`
identify distinct execution, evidence and acceptance records.

The first seed's v1 audit failed on set-to-JSON serialization before loading
checkpoint payloads. The [repair declaration](experiments/2026-09-25-bilinear-budget8000-replication-evidence-repair.md)
preserves that failure and versions the auditor and aggregate reader. V2 seed
audits and aggregate audit passed; no training was repeated for the repair.
The original aggregator never executed. Evidence-verifier revision 2 does not
change model or scientific evaluator identity.

The [additive inventory](experiments/2026-09-25-bilinear-budget8000-replication-model-version-inventory.json),
SHA `96fe9238fe1ea8bee910f06ba7aa2c8d2bb2e0381730c35c29338b73c03ef709`,
freshly verifies bytes for all **37 final checkpoints**. Older payloads/configs
and periodic checkpoints were not comprehensively re-audited. Local identity
hashes do not establish durable backup. See the [portable result](experiments/2026-09-25-bilinear-budget8000-replication.json)
and [Lesson 48](learning/48-testing-a-budget-across-parent-seeds.md).

## Paired budget geometry: descriptive evidence, unchanged model inventory

`bilinear-budget-geometry-v1` compares saved 2000/8000 scores for the same three
parent seeds. It creates no weights, inference policy or quality evaluator.
The current final-checkpoint inventory remains 37; no payloads were reread.
Its runner SHA is
`28a3e5f8491d1f3a903e3026d94d70643bfdcf4dd04b2033673c80f120d7f92d`;
summary `3264144d880fc4fea7487e80bc0a5e5e6275cf294c723af3cb3c0e5e5f24b38d`,
...
identify independently verified reductions and separate evidence acceptance.

Twelve of 14 fresh exact gains arose from already-separated errors. Shared
constant-threshold intervals remain empty globally and within dual-TYPE for
each seed at both budgets. This is a descriptive impossibility result for those
fixed score tables, not a threshold proposal or generalization claim. See the
[complete report index](experiments/2026-09-25-bilinear-budget-geometry.json) and
[Lesson 49](learning/49-how-error-boundaries-change-with-training.md). All nine
reduced reports are preserved; raw score reports remain local dependencies.
