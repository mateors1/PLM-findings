...
destination = root / "docs/experiments/2026-09-25-bilinear-residual-refit.json"
...
require(training["complete"] is True and training["completed_updates"] == 500, "complete fit")
