...
destination = root / "docs/experiments/2026-09-25-projection-worst-boundary.json"
...
require(
    audit["plan_sha256"]
    == summary["plan_sha256"]
    == "03bda47032fa65c11bf70904cb05f845fe10a89154e36a5edb5b76b0f5d7be9c",
    "frozen plan",
)
...
portable = {
    ...
    "mean_bce_diagnostic": audit["mean_bce_diagnostic"],
    "historical_mean_comparator": read(run / "mean-refit-comparator.json"),
    "paired_query_changes": read(run / "comparisons.json")["per_query"],
