...
require(sha(run / "summary.json") == args.summary_sha256, "aggregate primary identity")
...
aggregate_execution = read(run / "execution-receipt.json")
require(
    ...
    and aggregate_execution["stdout_sha256"] == sha(run / "primary-stdout.txt"),
...
decision = {
    ...
    "aggregate_execution_receipt_sha256": sha(run / "execution-receipt.json"),
    "children": children,
    "gate": audit["gate"],
